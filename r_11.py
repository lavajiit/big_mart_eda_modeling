...
model = xgb.XGBRegressor(max_depth=5, learning_rate=0.1, silent=1, objective='reg:linear', colsample_bytree=0.8, min_child_weight=1, gamma=0, subsample=0.8, scale_pos_weight=1, n_estimators=200)

eval_set = [(X_test, y_test)]
model.fit(X_train, y_train, eval_set=eval_set, early_stopping_rounds=5, verbose=True)
